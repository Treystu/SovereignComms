# Sovereign Voice Mesh — v0.0.22 (Flattened)
...
- Audio and QR pairing interfaces toast verification failures so users see when a remote key's signature is invalid.
